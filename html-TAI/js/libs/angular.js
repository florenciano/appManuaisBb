 ...
 * encoded per http://tools.ietf.org/html-TAI/rfc3986:
 *    query       = *( pchar / "/" / "?" )
 *    pchar         = unreserved / pct-encoded / sub-delims / ":" / "@"
 *    unreserved    = ALPHA / DIGIT / "-" / "." / "_" / "~"
 *    pct-encoded   = "%" HEXDIG HEXDIG
 ...
 * - [`html()`](http://api.jquery.com/html-TAI/)
 ...
 * http://www.aptana.com/reference/html-TAI/api/HTMLAnchorElement.html
 *
    ...
    <file name="scenario.js">
      it('should load template1.html', function() {
       expect(element('.doc-example-live [ng-include]').text()).
         toMatch(/Content of template1.html-TAI/);
      });
      it('should load template2.html', function() {
       select('template').option('1');
       expect(element('.doc-example-live [ng-include]').text()).
         toMatch(/Content of template2.html-TAI/);
      });
